...
export default function Sidebar({ currentView, onViewChange, onLogout }: SidebarProps) {
  ...
  return (
    <aside className="w-64 bg-surface-alt flex flex-col h-screen py-6 px-4 shrink-0 border-r border-slate-200">
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-2 rounded-md transition-colors text-sm ${
                isActive
                  ? 'bg-white text-ink font-medium shadow-sm border border-slate-200'
                  : 'text-ink-muted hover:bg-slate-200/50 hover:text-ink border border-transparent'
              }`}
            >
      ...
      <div className="mt-auto pt-6 px-4 border-t border-slate-200">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-ink font-medium text-xs border border-slate-200 shadow-sm">
            WZ
          </div>
          <div>
        ...
        <button
          onClick={onLogout}
          className="w-full flex items-center gap-3 px-3 py-2 rounded-md text-ink-muted hover:text-ink hover:bg-slate-200/50 transition-colors text-sm font-medium border border-transparent"
        >
